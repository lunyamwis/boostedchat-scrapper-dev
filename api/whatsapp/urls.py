...
urlpatterns = [
    ...
    path("whin/send/", views.SendMessageView.as_view(), name="whin-send"),
    path("whin/send-group/", views.SendGroupMessageView.as_view(), name="whin-send-group"),
    path("whin/set-webhook/", views.SetWebhookUrlView.as_view(), name="whin-set-webhook"),
    path("whin/show-webhook/", views.ShowWebhookUrlView.as_view(), name="whin-show-webhook"),
    path("whin/delete-webhook/", views.DeleteWebhookUrlView.as_view(), name="whin-delete-webhook"),
    path("whin/create-poll/", views.CreatePollView.as_view(), name="whin-create-poll"),
    path("whin/create-group/", views.CreateGroupView.as_view(), name="whin-create-group"),
    path("whin/my-group/", views.MyGroupView.as_view(), name="whin-my-group"),
    path("whin/get-qr/", views.GetQrView.as_view(), name="whin-get-qr"),
    path("whin/webhook/",views.WebhookView.as_view(), name="whin-webhook"),
    path("whin/webhook/post/", views.WebhookPostView.as_view(), name="whin-webhook-post"),
    path("whin/webhook/get/", views.WebhookGetView.as_view(), name="whin-webhook-get"),
    path("whin/wskchk/", views.WskCheckView.as_view(), name="whin-wskchk"),
    path("whin/signup/", views.SignupView.as_view(), name="whin-signup"),
