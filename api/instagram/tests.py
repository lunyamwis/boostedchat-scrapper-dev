...
class InstagramTests(TestCase):
    ...
    def test_hiker_user_clips(self):
        payload = {"user_id": "34468425907"}
        response = requests.post(f"{self.url}/instagram/user-clips/", json=payload)
    ...
    def test_hiker_user_followers(self):
        payload = {"user_id": "73467569887"}
        response = requests.post(f"{self.url}/instagram/user-followers/", json=payload)
    ...
    def test_hiker_user_followers_chunk_v2(self):
        payload = {"user_id": "73467569887"}
        response = requests.post(f"{self.url}/instagram/user-followers-chunk-v2/", json=payload)
    ...
    def test_hiker_user_following_chunk_v2(self):
        payload = {"user_id": "73467569887"}
        response = requests.post(f"{self.url}/instagram/user-following-chunk-v2/", json=payload)
    ...
    def test_hiker_user_highlights_by_username(self):
        payload = {"user_id": "73467569887"}
        response = requests.post(f"{self.url}/instagram/user-highlights-by-username/", json=payload)
    ...
    def test_hiker_user_medias_chunk_pinned_v1(self):
        payload = {"user_id": "73467569887"}
        response = requests.post(f"{self.url}/instagram/user-medias-chunk-pinned-v1/", json=payload)
    ...
    def test_hiker_user_tag_medias(self):
        payload = {"user_id": "73467569887"}
        response = requests.post(f"{self.url}/instagram/user-tag-medias/", json=payload)
    ...
    def test_hiker_userstream_by_id_v2(self):
        payload = {"user_id": "73467569887"}
        response = requests.post(f"{self.url}/instagram/user-stream-by-id-v2/", json=payload)
    ...
    def test_hiker_userstream_by_username_v2(self):
        payload = {"user_id": "73467569887"}
        response = requests.post(f"{self.url}/instagram/user-stream-by-username-v2/", json=payload)
