...
urlpatterns = [
    ...
    path('unipile/accounts/', views.LunyamwiInstagramAccountsView.as_view(), name='unipile_instagram_accounts'),
    path('unipile/accounts/<str:account_id>/', views.LunyamwiInstagramAccountView.as_view(), name='unipile_instagram_account'),
    path('unipile/accounts/<str:account_id>/status/', views.LunyamwiInstagramAccountStatusView.as_view(), name='unipile_instagram_account_status'),
    path('unipile/accounts/<str:account_id>/user/', views.LunyamwiInstagramUserProfileView.as_view(), name='unipile_instagram_user_profile'),
    path('unipile/accounts/<str:account_id>/users/search/', views.LunyamwiInstagramUserSearchView.as_view(), name='unipile_instagram_user_search'),
    path('unipile/accounts/<str:account_id>/users/followers/', views.LunyamwiInstagramUserFollowersView.as_view(), name='unipile_instagram_user_followers'),
    path('unipile/accounts/<str:account_id>/users/following/', views.LunyamwiInstagramUserFollowingView.as_view(), name='unipile_instagram_user_following'),
    path('unipile/accounts/<str:account_id>/posts/', views.LunyamwiInstagramPostsView.as_view(), name='unipile_instagram_posts'),
    path('unipile/accounts/<str:account_id>/posts/<str:post_id>/', views.LunyamwiInstagramPostView.as_view(), name='unipile_instagram_post'),
    path('unipile/accounts/<str:account_id>/posts/like/', views.LunyamwiInstagramPostLikeView.as_view(), name='unipile_instagram_post_like'),
    path('unipile/accounts/<str:account_id>/posts/upload/', views.LunyamwiInstagramUploadView.as_view(), name='unipile_instagram_upload'),
    path('unipile/accounts/<str:account_id>/posts/<str:post_id>/comments/', views.LunyamwiInstagramCommentsView.as_view(), name='unipile_instagram_comments'),
    path('unipile/accounts/<str:account_id>/comments/<str:comment_id>/', views.LunyamwiInstagramCommentView.as_view(), name='unipile_instagram_comment'),
    path('unipile/accounts/<str:account_id>/comments/like/', views.LunyamwiInstagramCommentLikeView.as_view(), name='unipile_instagram_comment_like'),
    path('unipile/accounts/<str:account_id>/messages/', views.LunyamwiInstagramMessagesView.as_view(), name='unipile_instagram_messages'),
    path('unipile/accounts/<str:account_id>/threads/', views.LunyamwiInstagramThreadsView.as_view(), name='unipile_instagram_threads'),
    path('unipile/accounts/<str:account_id>/stories/', views.LunyamwiInstagramStoriesView.as_view(), name='unipile_instagram_stories'),
    path('unipile/accounts/<str:account_id>/stories/react/', views.LunyamwiInstagramStoryReactionView.as_view(), name='unipile_instagram_story_reaction'),
    path('unipile/accounts/<str:account_id>/users/follow/', views.LunyamwiInstagramFollowView.as_view(), name='unipile_instagram_follow'),
    path('unipile/accounts/<str:account_id>/hashtags/', views.LunyamwiInstagramHashtagView.as_view(), name='unipile_instagram_hashtag'),
    path('unipile/accounts/<str:account_id>/locations/', views.LunyamwiInstagramLocationView.as_view(), name='unipile_instagram_location'),
    path('unipile/accounts/<str:account_id>/analytics/', views.LunyamwiInstagramAnalyticsView.as_view(), name='unipile_instagram_analytics'),
    path('unipile/webhook/', views.LunyamwiInstagramWebhookView.as_view(), name='unipile_instagram_webhook'),
]
