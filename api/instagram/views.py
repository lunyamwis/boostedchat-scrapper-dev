...
class HikerUserClips(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            if page_id:
                clips = cl.user_clips(user_id, count=count, page_id=page_id)
            else:
...
class HikerUserFollowers(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            if page_id:
                followers = cl.user_followers(user_id, count=count, page_id=page_id)
            else:
...
class HikerUserTagMedias(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            if page_id:
                tag_medias = cl.user_tag_medias(user_id, count=count, page_id=page_id)
            else:
                tag_medias = cl.user_tag_medias(user_id)
...
def make_lunyamwi_instagram_request(endpoint: str, method: str = "POST", payload: dict = None, headers: dict = None) -> dict:
    """Helper function to make requests to Lunyamwi Instagram API"""
    url = f"{LUNYAMWI_INSTAGRAM_BASE_URL}{endpoint}"
    
    default_headers = {
        "Authorization": f"Bearer {LUNYAMWI_INSTAGRAM_API_KEY}",
        "Content-Type": "application/json"
    }
    ...
    try:
        if method.upper() == "GET":
            response = requests.get(url, params=payload, headers=default_headers, timeout=30)
        else:
            response = requests.request(method, url, json=payload, headers=default_headers, timeout=30)
...
class LunyamwiInstagramAccountsView(APIView):
    """Get all Instagram accounts"""
    permission_classes = [AllowAny]
    
    def get(self, request):
        result = make_lunyamwi_instagram_request("/accounts", method="GET")
    ...
    def post(self, request):
        ...
        result = make_lunyamwi_instagram_request("/accounts", payload=payload)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramAccountView(APIView):
    """Manage specific Instagram account"""
    permission_classes = [AllowAny]
    
    def get(self, request, account_id):
        result = make_lunyamwi_instagram_request(f"/accounts/{account_id}", method="GET")
        return Response(result, status=result.get('status_code', 500))
    
    def put(self, request, account_id):
        """Update account"""
        payload = request.data
        result = make_lunyamwi_instagram_request(f"/accounts/{account_id}", method="PUT", payload=payload)
        return Response(result, status=result.get('status_code', 500))
    
    def delete(self, request, account_id):
        """Delete account"""
        result = make_lunyamwi_instagram_request(f"/accounts/{account_id}", method="DELETE")
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramAccountStatusView(APIView):
    """Get account status"""
    permission_classes = [AllowAny]
    
    def get(self, request, account_id):
        result = make_lunyamwi_instagram_request(f"/accounts/{account_id}/status", method="GET")
        return Response(result, status=result.get('status_code', 500))

# User Profile Endpoints
class LunyamwiInstagramUserProfileView(APIView):
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/user", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramUserSearchView(APIView):
    """Search users"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/users/search", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramUserFollowersView(APIView):
    """Get user followers"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/users/followers", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramUserFollowingView(APIView):
    """Get user following"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/users/following", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

# Posts/Media Endpoints
class LunyamwiInstagramPostsView(APIView):
    """Get posts from feed or user"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        limit = request.query_params.get('limit', 20)
        cursor = request.query_params.get('cursor')
        feed_type = request.query_params.get('feed_type', 'user')  # user, home, explore
        ...
        result = make_lunyamwi_instagram_request("/instagram/posts", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramPostView(APIView):
    """Get specific post"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id, post_id):
        ...
        result = make_lunyamwi_instagram_request(f"/instagram/posts/{post_id}", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramPostLikeView(APIView):
    """Like/Unlike a post"""
    permission_classes = [AllowAny]
    ...
    def post(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/posts/like", payload=payload)
        return Response(result, status=result.get('status_code', 500))
    ...
    def delete(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/posts/unlike", method="DELETE", payload=payload)
        return Response(result, status=result.get('status_code', 500))

# Comments Endpoints
class LunyamwiInstagramCommentsView(APIView):
    """Get post comments"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id, post_id):
        ...
        result = make_lunyamwi_instagram_request(f"/instagram/posts/{post_id}/comments", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))
    ...
    def post(self, request, account_id, post_id):
        ...
        result = make_lunyamwi_instagram_request(f"/instagram/posts/{post_id}/comments", payload=payload)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramCommentView(APIView):
    ...
    def delete(self, request, account_id, comment_id):
        ...
        result = make_lunyamwi_instagram_request(f"/instagram/comments/{comment_id}", method="DELETE", payload=payload)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramCommentLikeView(APIView):
    ...
    def post(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/comments/like", payload=payload)
        return Response(result, status=result.get('status_code', 500))
    ...
    def delete(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/comments/unlike", method="DELETE", payload=payload)
        return Response(result, status=result.get('status_code', 500))

# Direct Messages Endpoints
class LunyamwiInstagramMessagesView(APIView):
    """Get direct messages"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/messages", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))
    ...
    def post(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/messages", payload=payload)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramThreadsView(APIView):
    """Get message threads"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/threads", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

# Stories Endpoints
class LunyamwiInstagramStoriesView(APIView):
    """Get stories"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/stories", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

class LunyamwiInstagramStoryReactionView(APIView):
    """React to story"""
    permission_classes = [AllowAny]
    ...
    def post(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/stories/react", payload=payload)
        return Response(result, status=result.get('status_code', 500))

# Follow/Unfollow Endpoints
class LunyamwiInstagramFollowView(APIView):
    ...
    def post(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/users/follow", payload=payload)
        return Response(result, status=result.get('status_code', 500))
    ...
    def delete(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/users/unfollow", method="DELETE", payload=payload)
        return Response(result, status=result.get('status_code', 500))

# Upload/Publishing Endpoints
class LunyamwiInstagramUploadView(APIView):
    """Upload media"""
    permission_classes = [AllowAny]
    ...
    def post(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/posts/upload", payload=payload)
        return Response(result, status=result.get('status_code', 500))

# Hashtag Endpoints
class LunyamwiInstagramHashtagView(APIView):
    """Get hashtag information and posts"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/hashtags", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

# Location Endpoints
class LunyamwiInstagramLocationView(APIView):
    """Get location posts"""
    permission_classes = [AllowAny]
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/locations", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

# Analytics Endpoints
class LunyamwiInstagramAnalyticsView(APIView):
    ...
    def get(self, request, account_id):
        ...
        result = make_lunyamwi_instagram_request("/instagram/analytics", method="GET", payload=params)
        return Response(result, status=result.get('status_code', 500))

# Webhooks Endpoint
class LunyamwiInstagramWebhookView(APIView):
    """Handle webhooks from Lunyamwi"""
    permission_classes = [AllowAny]
    ...
    def post(self, request):
        ...
        # You can add your custom logic to handle different webhook events
