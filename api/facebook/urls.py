...
urlpatterns = [
    ...
    path('broadcast-messages/', views.FacebookBroadcastMessagesView.as_view(), name='facebook_broadcast_messages'),
    ...
    path('ad-accounts/', views.FacebookAdAccountsView.as_view(), name='facebook_ad_accounts'),
    path('ad-accounts/<str:ad_account_id>/', views.FacebookAdAccountView.as_view(), name='facebook_ad_account'),
    path('ad-accounts/<str:ad_account_id>/campaigns/', views.FacebookCampaignsView.as_view(), name='facebook_campaigns'),
    path('ad-accounts/<str:ad_account_id>/adsets/', views.FacebookAdSetsView.as_view(), name='facebook_adsets'),
    path('ad-accounts/<str:ad_account_id>/ads/', views.FacebookAdsView.as_view(), name='facebook_ads'),
    path('ad-accounts/<str:ad_account_id>/insights/', views.FacebookAdInsightsView.as_view(), name='facebook_ad_insights'),
    ...
    path('groups/', views.FacebookGroupsView.as_view(), name='facebook_groups'),
    ...
    path('app/', views.FacebookAppView.as_view(), name='facebook_app'),
